...
def getTripAdvisorLink(city, country) :
    ...
    return "https://www.tripadvisor.com/Search?q=" + city + " " + country
...
</dt>""".format(name = name.replace(" ", "+"), city = city, country = country, counter = i)
...
def getCrazyTouristLink(city, country) :
    ...
    return "https://www.thecrazytourist.com?s=" + city + "+" + country
